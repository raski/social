...
const defaultData = {
	...
	comments: [],         // hämtade Facebook-kommentarer, för "minnet" av vad en person tidigare kommenterat
	snapshots: [],         // dagliga ögonblicksbilder av aggregerad statistik per profil, för period-rapporter
};
