...
// getStats finns medvetet INTE för X – varje läsanrop mot X:s API kostar pengar
// ($0,005/anrop sedan februari 2026), så statistikhämtning är avstängd för den här
// plattformen. Övriga plattformar (Facebook, Mastodon, Bluesky, Threads) är gratis att läsa
// från och behåller sin getStats som vanligt.
